		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.kustomization_build.test", "ids_namespace_not_set.#", "1"),
					resource.TestCheckResourceAttr("data.kustomization_build.test", "ids_namespace_set.#", "3"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.kustomization.test", "ids_namespace_not_set.#", "1"),
					resource.TestCheckResourceAttr("data.kustomization.test", "ids_namespace_set.#", "3"),
